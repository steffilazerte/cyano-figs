...
g1 <- g0 %+% drop_na(fig2_4, chl) +
  geom_point(aes(y = chl), colour = blu, na.rm = TRUE) +
...
g2 <- g0 %+% drop_na(fig2_4, secchi) +
  ...
  geom_point(aes(y = secchi, shape = humic_fct), colour = blu, na.rm = TRUE) +
  ...
  scale_y_log10(limits = c(NA, 50), breaks = y_breaks)
g2
```
...
g3 <- g0 %+% drop_na(fig2_4, doc) +
  geom_point(aes(y = doc), colour = blu, na.rm = TRUE) +
...
g4 <- g0 %+% drop_na(fig2_4, color) +
  geom_point(aes(y = color), colour = blu, na.rm = TRUE) +
...
g5 <- g0 %+% drop_na(fig2_4, pri_proa) +
  geom_point(aes(y = pri_proa), colour = blu, na.rm = TRUE) +
...
g6 <- g0 %+% drop_na(fig2_4, bac) +
  geom_point(aes(y = bac), colour = blu, na.rm = TRUE) +
